	...
	Glide.prototype.navigation = function() {
		...
		for (var i = 0; i < this.slides.length; i++) {
			this.navigation.items[i] = $('<a />', {
				...
				'data-distance': i, 
				'style': 'background-image:url(images/testimonial_client'+i+'.jpg)', 
			}).appendTo(this.navigation.wrapper);
		}

		// Add navCurrentItemClass to the first navigation item
		var middleSlideItem = Math.round((this.slides.length)/2);
		this.navigation.items[middleSlideItem-1].addClass(this.options.navigationCurrentItemClass);
